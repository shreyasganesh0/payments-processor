# Context
Floating point artihmetic is imprecise and unacceptable for money transactions.
...
## Consequences
- have to take care to use string parsing instead of flaot for conversions
